          ...
          <div class="col-md-12">
            ...
            <div class="VerticalTab VerticalTab_hash_scroll VerticalTab_6 tabs_ver_6">
              ...
              <ul class="resp-tabs-list hor_1">
				...
				<li class="tabs-4" data-tab-name="login"><span class="tabs-text">Log In</span></li>
              </ul>
...
if($con)
{
    mysqli_select_db($con,$dbname) or die("cannot connect to the database!");    
}
else
{
...
$qry="select * from registration where uname='$uname' and pword='$pass'";
//execute the command
